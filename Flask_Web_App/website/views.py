...
def dd():
    ...
    ls_vis_Stocks,ls_vis_values,date_list = dbToList() #Alters the database table data for visualization purposes. A dictionary with all the top ten stocks and its stock mentions for the last week is included. A list of the respective dates is included as well.
